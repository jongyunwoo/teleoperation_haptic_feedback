...
class Inspire_Controller:
    def __init__(self, left_hand_array, right_hand_array, dual_hand_data_lock=None, dual_hand_state_array=None,
        ...
        hand_control_process = Process(target=self.control_process_loop, args=(
            ...
            dual_hand_touch_array, dual_hand_force_array))
    ...
    def _subscribe_hand_state_loop(self):
        ...
        while True:
            ...
            if left_touch_msg is not None:
                ...
                if hasattr(left_touch_msg, 'fingertwo_palm_touch') and len(left_touch_msg.fingertwo_tip_touch) == 9:
                    with self.left_tactile_array.get_lock():
                        for i in range(9):
    ...
    def _send_hand_command(self, left_angle_cmd_scaled, right_angle_cmd_scaled, left_force_cmd_scaled, right_force_cmd_scaled, left_speed_cmd_scaled, right_speed_cmd_scaled):
        ...
        left_cmd_msg.mode = 0b1101 # Mode 13 : Angle + Force + Velocity
        ...
        right_cmd_msg.mode = 0b1101 # Mode 1: Angle control
